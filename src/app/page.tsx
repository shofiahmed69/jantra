      ...
      <div className="relative z-10 px-6 pb-12 pt-0 flex flex-col items-center text-center">
        ...
        >
          ...
          <div className="flex flex-row gap-3 w-full px-2">
            ...
            <Link
              href="/contact"
              className="flex-1 rounded-xl py-3.5 text-[12px] font-black text-slate-800 text-center border border-slate-200 bg-white/80 active:scale-95 transition-transform"
            >
              Contact
            </Link>
          </div>
          ...
          <div className="flex items-center justify-center gap-3 mt-6 pt-5 border-t border-slate-100/60" id="trust-mob">
            ...
            <div className="text-left leading-none">
              ...
              <p className="text-[8px] text-slate-400 font-bold uppercase tracking-wider mt-0.5">Global Scale</p>
            </div>
