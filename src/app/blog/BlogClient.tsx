                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 sm:gap-20">
                        {filteredPosts.map((post, i) => {
                            ...
                            return (
                                ...
                                >
                                    <Link href={`/blog/${post.slug}`} prefetch className="contents">
                                    {/* IMAGE HERO */}
                                    ...
                                    <div className="px-4 space-y-4 text-left">
                                        ...
                                        <span className="inline-flex items-center gap-4 text-[10px] sm:text-xs font-black text-slate-950 uppercase tracking-widest pt-4 group-hover:translate-x-2 transition-transform">
